...
window.dashboardLima = {
  studentsStatsLima: (dataValues) => {
    ...
    for (let k = 0; k < dataStudentsThirdLima.length; k++) {
...
window.dashboardMexico = {
  studentsStatsMex: (dataValues) => {
...
window.dashboardStgo = {
  studentsStatsStgo: (dataStgo) => {
